...
4. **Final Gate Lock**:
   - Once all specs compile cleanly (`valid: true` with zero errors), check off Stage 6 in `.wai/phased_design.md` to unlock agent generation (`node "C:/Users/ShutYourWaffle/source/Waffle-AIron/dist/cli/index.js" generate`).
