...
2. **Synthesize Project Context (Stage 1)**:
   ...
   - Edit `.wai/context/project.md` directly to write this synthesized context. Do NOT run or recommend any non-existent context commands (e.g. `node "C:/Users/ShutYourWaffle/source/Waffle-AIron/dist/cli/index.js" context init`).
