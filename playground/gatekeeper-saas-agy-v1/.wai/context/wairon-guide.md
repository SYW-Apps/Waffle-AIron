...
| ID | Source | Name |
|----|--------|------|
| `billing` | subsystem `billing` | Billing Subsystem |
| `gatekeeper` | subsystem `gatekeeper` | Gatekeeper Subsystem |
| `notification` | subsystem `notification` | Notification Subsystem |
