...
description: Owns the sdd_skills subsystem. Bootstraps and synchronizes the built-in SDD AI Skills (sdd-architect, sdd-narrative, sdd-auditor, sdd-implement, sdd-delegate) to local AI…
---
...
.wai/specs/components/instructions_specialist.yaml
