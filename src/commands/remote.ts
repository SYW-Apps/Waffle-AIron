...
import { exportSpecTree, importSpecTree } from './adapters/core.js';
...
// cli_remote_adapter — the HTTP edge onto a remote instance, in a module of its own.
import {
  exportRemoteTree,
  importRemoteTree,
  validateRemoteTree,
...
export type { RemoteTarget } from './adapters/remote.js';

// ---------------------------------------------------------------------------
// Remote Migration Orchestrator + `wairon remote`
