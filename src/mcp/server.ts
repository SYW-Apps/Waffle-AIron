...
function publicInterfacesReplacement(
  ...
  // store does not publish it: bound → component[.interface], unbound → type details.
  const identity = (pi: PublicInterface): string => (pi.component
